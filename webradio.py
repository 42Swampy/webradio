				...
				if (auswahl_menu == 8):
					...
					while (abbruch5 == 0):
						...
						if (taste1 == 1):
							...
							station = station.replace(" Jan:",". Jan:")
							station = station.replace(" Feb:",". Feb:")
							station = station.replace(" Mar:",(". Mär:"))
							station = station.replace(" Apr:",". Apr:")
							station = station.replace(" May:",". Mai:")
							station = station.replace(" Jun:",". Jun:")
							station = station.replace(" Jul:",". Jul:")
							station = station.replace(" Aug:",". Aug:")
							station = station.replace(" Sep:",". Sep:")
							station = station.replace(" Oct:",". Okt:")
							station = station.replace(" Nov:",". Nov:")
							station = station.replace(" Dec:",". Dez:")
							station = station.replace(" Mon "," Mo. ")
							station = station.replace(" Tue "," Di. ")
							station = station.replace(" Wed"," Mi. ")
							station = station.replace(" Thu "," Do. ")
							station = station.replace(" Fri "," Fr. ")
							station = station.replace(" Sat "," Sa. ")
							station = station.replace(" Sun "," So. ")
							station = station.replace(" NNE "," NNO ")
							station = station.replace(" NE "," NO ")
							station = station.replace(" ENE "," ONO ")
							station = station.replace(" E "," O ")
							station = station.replace(" ESE "," OSO ")
							station = station.replace(" SE "," SO ")
							station = station.replace(" SSE "," SSO ")
							station = station.replace("ERROR : Cannot fetch weather data","FEHLER : Konnte Wetterdaten nicht holen")
							laenge = len(station)
							bereich = laenge - 19
							print (bereich)
							print (station)
